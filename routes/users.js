...
var returnUsersRouter = function(io) {
  ...
  //   } else {
  //     siteFunc.renderToTargetPageByType(req, res, 'user', {
  //       title: '用户登录',
  //       page: 'userLogin'
  //     });
  //   }
  ...
  //               siteFunc.renderToTargetPageByType(req, res, 'userInfo', {
  //                 key: 'warning',
  //                 value: '链接超时，密码无法重置。',
  //                 page: 'userNotice'
  //               });
  ...
  //         res.end(err);
  //       } else {
  //         if (user.password == keyArr[0] && keyArr[2] == settings.session_secret && validator.isPsd(req.body.password) && validator.isLength(req.body.password, 6, 12)) {
  //
  ...
  //   if (isLogined(req)) {
  //     siteFunc.renderToTargetPageByType(req, res, 'userNotice', {
  //       title: '我的消息',
  //       page: 'userMessage'
  //     });
  //   } else {
  ...
  //   if (isLogined(req)) {
  //     siteFunc.renderToTargetPageByType(req, res, 'userReply', {
  //       title: '参与话题',
  //       page: 'userReplies'
  //     });
  //   } else {
